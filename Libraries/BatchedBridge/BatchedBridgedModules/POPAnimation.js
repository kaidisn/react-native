...
if (!RCTPOPAnimationManager) {
  ...
  var POPAnimation = {
    ...
    createAnimation: function (typeName: number, attrs: Attrs): number {
      ...
      if (__DEV__) {
        var attributeChecker = POPAnimation.attributeChecker;
        checkPropTypes({ attrs: attributeChecker }, { attrs }, 'attrs', 'POPAnimation.createAnimation');
        checkPropTypes({ attrs: attributeChecker }, { attrs: { type: typeName } }, 'attrs', 'POPAnimation.createAnimation');
      }
