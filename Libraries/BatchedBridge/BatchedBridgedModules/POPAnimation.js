...
if (!RCTPOPAnimationManager) {
  ...
  var POPAnimation = {
    ...
    createAnimation: function (typeName: number, attrs: Attrs): number {
      ...
      if (__DEV__) {
        POPAnimation.attributeChecker({ attrs }, 'attrs', 'POPAnimation.createAnimation');
        POPAnimation.attributeChecker({ attrs: { type: typeName } }, 'attrs', 'POPAnimation.createAnimation');
      }
